...
interface AdminDashboardProps {
  ...
  onOpenBatchBlock: () => void; // New Prop
}
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const handleSubmitCoach = (e: React.FormEvent) => {
    e.preventDefault();
    // If it's new, we need email and password. ID will be generated by Auth.
    // If it's edit, we need ID.
       ...
       {adminTab === 'analysis' && (
          <div className="space-y-6 animate-slideUp">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="glass-panel p-6 rounded-3xl relative overflow-hidden h-80">
                  ...
                  <div className="space-y-3 relative z-10 overflow-y-auto h-[220px] custom-scrollbar">
               ...
               <div className="glass-panel p-6 rounded-3xl flex flex-col justify-center h-80">
               ...
               <div className="glass-panel p-6 rounded-3xl md:col-span-1 flex flex-col h-80">
                  ...
                  <div className="overflow-y-auto flex-1 custom-scrollbar pr-2">
                      <div className="grid grid-cols-4 gap-2 text-xs font-bold text-gray-400 mb-3 uppercase tracking-wider sticky top-0 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm p-1 rounded z-10">
                          <span>教練</span>
